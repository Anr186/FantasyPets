...
#include "../../FantasyPets/welcomewindow.h"
...
QT_MOC_LITERAL(1, 14, 17), // "playButtonClicked"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "WelcomeWindow\0playButtonClicked\0"
};
...
void WelcomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WelcomeWindow::playButtonClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WelcomeWindow::playButtonClicked()
{
